  ...
  const contenus = [
    {
      ...
      slides: JSON.stringify([
        { titre: "Paris vue d'en haut", phrase: "Quand le coucher de soleil se mêle au champagne sur les toits", photoId: "1519864600265-abb23847ef5b" },
        { titre: "Une cuisine d'exception", phrase: "Chaque plat raconte une histoire de saveurs méditerranéennes", photoId: "1519864600265-abb23847ef5b" },
        { titre: "L'ambiance qui fait tout", phrase: "Musique, lumières tamisées et compagnie parfaite", photoId: "1519864600265-abb23847ef5b" },
        { titre: "Rejoins nos dîners privés", phrase: "Envoie-nous un message pour participer gratuitement", photoId: "1519864600265-abb23847ef5b" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Hôtel particulier discret", phrase: "Un palace caché au cœur du 16ème arrondissement", photoId: "1492571350019-22de08371d37" },
        { titre: "Bar signature", phrase: "Les cocktails les plus photographiés de tout Paris", photoId: "1492571350019-22de08371d37" },
        { titre: "Soirée intime & triée", phrase: "50 invitées. Aucune publicité. Tout le frisson.", photoId: "1492571350019-22de08371d37" },
        { titre: "Ta prochaine soirée", phrase: "Envoie-nous un DM pour rejoindre la liste VIP", photoId: "1492571350019-22de08371d37" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Vue sur la Tour Eiffel", phrase: "Dîner avec le plus beau décor du monde en fond", photoId: "1503917988258-f87a78e3c995" },
        { titre: "Cuisine franco-méditerranéenne", phrase: "Des saveurs qui transportent, une vue qui captive", photoId: "1503917988258-f87a78e3c995" },
        { titre: "Privatisation exclusive", phrase: "Une sélection pointue, une atmosphère électrique", photoId: "1503917988258-f87a78e3c995" },
        { titre: "Sois des nôtres", phrase: "Réponds à notre story pour rejoindre la prochaine soirée", photoId: "1503917988258-f87a78e3c995" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Jardin des Tuileries", phrase: "Un restaurant suspendu entre Paris et l'art", photoId: "1473116763249-eb81d4fa6e6e" },
        { titre: "Cuisine italienne chic", phrase: "Les meilleures pâtes fraîches dans un cadre incomparable", photoId: "1473116763249-eb81d4fa6e6e" },
        { titre: "Ambiance décontractée luxe", phrase: "Le bon équilibre entre chic et fun", photoId: "1473116763249-eb81d4fa6e6e" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Le restaurant le plus mystérieux de Paris", phrase: "Depuis 1766, Lapérouse garde ses secrets", photoId: "1551218372-a8789b81b253" },
        { titre: "Salons privés historiques", phrase: "Chaque cabinet raconte une romance parisienne", photoId: "1551218372-a8789b81b253" },
        { titre: "Expérience sensorielle totale", phrase: "Cuisine gastronomique dans un décor de velours et d'or", photoId: "1551218372-a8789b81b253" },
        { titre: "Une soirée hors du temps", phrase: "Places rares. Accès sur invitation uniquement.", photoId: "1551218372-a8789b81b253" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Montmartre vu du ciel", phrase: "Le rooftop le plus photogénique du 18ème", photoId: "1502602493604-6018e1c46f7a" },
        { titre: "Cocktails sunset", phrase: "Quand le soleil se couche sur Sacré-Cœur depuis ton verre", photoId: "1502602493604-6018e1c46f7a" },
        { titre: "Les meilleures personnes", phrase: "Un cercle sélect qui se retrouve chaque semaine", photoId: "1502602493604-6018e1c46f7a" },
        { titre: "La prochaine fois c'est toi", phrase: "Réponds à notre story pour rejoindre la liste", photoId: "1502602493604-6018e1c46f7a" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "L'hôtel des artistes", phrase: "Le Lutetia, palace Saint-Germain au passé légendaire", photoId: "1414235077428-338989a2e8c0" },
        { titre: "Brasserie d'exception", phrase: "Les huîtres les plus fraîches et le champagne en abondance", photoId: "1414235077428-338989a2e8c0" },
        { titre: "Soirée très select", phrase: "30 places. Ambiance feutrée. Robe exigée.", photoId: "1414235077428-338989a2e8c0" },
      ]),
    ...
    },
    {
      ...
      slides: JSON.stringify([
        { titre: "Le club le plus secret de Paris", phrase: "Imaginé par David Lynch, accessible aux élus", photoId: "1508214751196-bcfd4ca60f91" },
        { titre: "Architecture unique", phrase: "Chaque salle est une œuvre d'art habitée", photoId: "1508214751196-bcfd4ca60f91" },
        { titre: "La nuit parisienne dans sa version la plus pure", phrase: "Ni vu ni connu, juste ressenti", photoId: "1508214751196-bcfd4ca60f91" },
        { titre: "Tu veux entrer ?", phrase: "La liste est fermée. Envoie un DM quand même.", photoId: "1508214751196-bcfd4ca60f91" },
      ]),
